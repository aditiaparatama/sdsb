                ...
                <div class="card">
                    <div class="body">
                        <h2 class="card-inside-title">
                            Transfer Dana Baru
                            <small>Tambah transfer dana baru
                                <a href="<?php echo DOMAIN_WEB; ?>" target="_blank"><?php echo DOMAIN_WEB; ?></a>
                            </small>
                        </h2><br>

                        <form action="<?php echo base_url('transaksi/addtransfer_act'); ?>" method="POST">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <select class="form-control show-tick" name="tujuan" required>
                                    ...
                                    <?php foreach ($brands as $brand) {?>
                                        <option value="<?php echo $brand->bnama; ?>">DEPOSIT <?php echo $brand->bnama; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="col-sm-12">
