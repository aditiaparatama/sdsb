                ...
                <div class="card">
                    <div class="body">
                        <h2 class="card-inside-title">
                            REPORT PEMBELIAN KUPON
                            <small>Silahkan pilih periode pembelian kupon
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="dari" name="dari" class="datepicker form-control" placeholder="Tanggal Awal" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="sampai" name="sampai" class="datepicker form-control" placeholder="Tanggal Akhir" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
...
function GetCari(){
  ...
  $.ajax({
  type: "POST",
  url: "<?php echo base_url('general/reportkupon_act'); ?>",
