                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        ...
                        <div class="caption font-red-sunglo pull-right">
                            <span class="caption-subject bold uppercase"> Rp. <?php echo number_format($customer->deposito_customer); ?></span>
                        </div>
                    </div>
                    <div class="portlet-body form">
                        ...
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a class="btn sbold green" href="<?php echo base_url('deposit/tambahdeposit'); ?>"> TAMBAH DEPOSIT
                        ...
                        <table class="table table-striped table-bordered table-hover order-column" id="">
                            ...
                            <?php 
                                ...
                                }else if($list->status_deposit == 2){
                                    $status = 'Verifikasi Pembayaran';
                                }else if($list->status_deposit == 1){
                                    $status = 'Lunas';
                                }
                            ?>
                            <tr>
                                <td><?php echo $list->nomor_deposit; ?></td>
                                <td><b><?php echo $list->potongan_deposit; ?>%</b></td>
                                <td><b>Rp. <?php echo number_format($list->grandtotal_deposit); ?></b></td>
                                <td><?php echo $status; ?></td>
                                <td><?php echo date('d F Y', strtotime($list->date_deposit)); ?></td>
                            </tr>
                            <?php } ?>
                            </tbody>
                        </table>
