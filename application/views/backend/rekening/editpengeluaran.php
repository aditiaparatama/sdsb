                ...
                <div class="card">
                    <div class="body">
                        <h2 class="card-inside-title">
                            Pengeluaran Dana
                            <small>Transfer pengeluaran dana baru
                            <a href="<?php echo DOMAIN_WEB; ?>" target="_blank"><?php echo DOMAIN_WEB; ?></a></small>
                        </h2><br>

                        <form action="<?php echo base_url('rekening/editpengeluaran_act'); ?>" method="POST">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="sumber" class="form-control" value="<?php echo $detail->ttujuan; ?>" required>
