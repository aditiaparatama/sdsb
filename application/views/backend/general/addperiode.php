                ...
                <div class="card">
                    <div class="body">
                        <h2 class="card-inside-title">
                            Periode Kupon
                            <small>Periode kupon baru
                                <a href="<?php echo DOMAIN_WEB; ?>" target="_blank"><?php echo DOMAIN_WEB; ?></a>
                            </small>
                        </h2><br>

                        <form action="<?php echo base_url('general/addperiode_act'); ?>" method="POST">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="periode1" class="datepicker form-control" placeholder="Awal Periode" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="periode2" class="datepicker form-control" placeholder="Akhir Periode" required>
                                    </div>
                                </div>
                            </div>
