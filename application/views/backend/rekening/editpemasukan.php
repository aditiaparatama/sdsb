                ...
                <div class="card">
                    <div class="body">
                        <h2 class="card-inside-title">
                            Edit Pemasukan Dana
                            <small>Edit transfer pemasukan dana
                            <a href="<?php echo DOMAIN_WEB; ?>" target="_blank"><?php echo DOMAIN_WEB; ?></a></small>
                        </h2><br>

                        <form action="<?php echo base_url('rekening/editpemasukan_act'); ?>" method="POST">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="keterangan" class="form-control" value="<?php echo $detail->tketerangan; ?>" required>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="sumber" class="form-control" value="<?php echo $detail->tdari; ?>" required>
                            ...
                            <div class="col-sm-12">
                                ...
                                <select class="form-control show-tick" name="penerima" required>
                                    ...
                                    ?>
                                    <option value="<?php echo $terima->rno; ?>" <?php if($detail->rno==$terima->rno) echo 'selected="selected"'?>>
                            ...
                            <div class="col-sm-12">
                                ...
                                <button type="submit" name="submit" class="btn btn-primary btn-lg waves-effect">EDIT</button>&nbsp;&nbsp;
