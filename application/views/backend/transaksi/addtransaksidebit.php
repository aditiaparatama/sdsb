                ...
                <div class="card">
                    <div class="body">
                        <h2 class="card-inside-title">
                            Input Transaksi Harian Deposit <?php echo $brand; ?>
                            <small>Tambah deposit baru <?php echo $brand; ?>
                            <a href="<?php echo DOMAIN_WEB; ?>" target="_blank"><?php echo DOMAIN_WEB; ?></a></small>
                        </h2><br>

                        <form action="<?php echo base_url('transaksi/addtransaksidebit_act'); ?>" method="POST">
                        <div class="row clearfix">
                            <div class="col-sm-12">
