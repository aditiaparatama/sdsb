                ...
                <div class="card">
                    <div class="body">
                        <h2 class="card-inside-title">
                            Rekening Baru
                            <small>Tambah nomor rekening
                            <a href="<?php echo DOMAIN_WEB; ?>" target="_blank"><?php echo DOMAIN_WEB; ?></a></small>
                        </h2><br>

                        <form action="<?php echo base_url('rekening/addrekening_act'); ?>" method="POST">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="saldo" class="form-control" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" required>
                            ...
                            <div class="col-sm-12">
                                <select class="form-control show-tick" name="jenis">
                                    <option value="0" selected="selected">- ATUR REKENING SEBAGAI -</option>
                                    <option value="1">Penerima</option>
                                    <option value="2">Pentransfer</option>
                                </select>
                            </div>
                            <div class="col-sm-12">
