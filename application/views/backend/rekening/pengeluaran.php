                ...
                <div class="card">
                    <div class="header">
                        <h2>
                            ...
                            <small>Daftar pengeluaran transaksi rekening yang aktif 
                                <a href="<?php echo DOMAIN_WEB; ?>" target="_blank"><?php echo DOMAIN_WEB; ?></a>
                            </small>
                        </h2>
                        <a href="<?php echo base_url('rekening/addpengeluaran'); ?>" type="button" class="btn bg-orange waves-effect pull-right" 
                            style="color:#fff;margin-top: -4%;">
                            <i class="material-icons">add_box</i><span>Pengeluaran Rekening Baru</span>
                        </a>
                    </div>
                    <div class="body">
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                        <a href="<?php echo base_url('rekening/editpengeluaran/'.$list->tnomor); ?>" type="button" class="btn bg-light-blue btn-circle waves-effect waves-circle waves-float" data-toggle="tooltip" data-placement="top" title="Edit Pengeluaran" style="color:#fff;"><i class="material-icons">border_color</i>
                                        </a>

                                        <a href="<?php echo base_url('rekening/hapuspengeluaran/'.$list->tnomor); ?>" type="button" class="btn bg-red 
