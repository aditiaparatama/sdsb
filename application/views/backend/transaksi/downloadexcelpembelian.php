...
header("Content-Disposition: attachment; filename=Transaksi-Deposit.xls");  //File name extension was wrong
header("Expires: 0");
...
<table>
    <tr>
        <td><strong>Transaksi Deposit</strong></td>
    </tr>    
    <tr>
        <td>Daftar penambahan deposit customer yang berhasil di proses #ContentManagenetSystem(CMS)</td>
    </tr>
</table>
<br>
<table border-collapse="collapse">
    <tr bgcolor="blue">
        ...
        <td colspan="2">Bukti Transger</td>
    </tr>
    <?php 
