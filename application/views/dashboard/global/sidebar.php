    ...
    <div class="portlet light profile-sidebar-portlet ">
        ...
        <div class="profile-usermenu">
            <ul class="nav">
                ...
                <li><a href="<?php echo base_url('dashboard/transfer'); ?>"><i class="fa fa-retweet"></i> Transfer Dana </a></li>
                ...
                <li><a href="<?php echo base_url('dashboard/logoutdashboard'); ?>"><i class="fa fa-sign-out"></i> Log Out </a></li> 
            </ul>
        </div>
    </div>
</div>