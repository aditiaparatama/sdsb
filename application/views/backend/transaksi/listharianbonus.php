                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    ...
                                    <li><a href="<?php echo base_url('transaksi/addtransaksibonus/'.$idbrand); ?>">Input Bonus Permainan</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                    <div class="body">
                        <ul class="nav nav-tabs tab-nav-right" role="tablist">
                            ...
                            <li role="presentation" class="active">
                                <a href="<?php echo base_url('transaksi/listharianbonus/'.$idbrand); ?>">BONUS PERMAINAN</a>
                            </li>
                        </ul><br>
