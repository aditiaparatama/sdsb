            ...
            <table class="table table-hover">
                <thead>
                    <tr class="bg-light-blue">
                        ...
                        <th>No Rekening</th>
                        <th style="min-width: 120px;">User SBOTBET</th>
                        <th style="min-width: 120px;">User IBCBET</th>
                        ...
                        <th style="min-width: 140px;">Deposit IBCBET</th>
    			...
    			<?php $cdepo1 += $list->cdepositsbo; $cdepo2 += $list->cdepositibc; $cdepo3 += $list->cdeposithorey; $cdepo4 += $list->cdeposittangkas; $cdepo5 += $list->cdeposit; } ?>
                </tbody>
                <tfoot class="bg-grey">
                        <th></th>
                        <th></th>
