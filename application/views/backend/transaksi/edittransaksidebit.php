                ...
                <div class="card">
                    <div class="body">
                        <h2 class="card-inside-title">
                            Edit Transaksi Harian Deposit <?php echo $brand; ?>
                            <small>Edit transaksi harian pemasukan dana <?php echo $brand; ?>
                            <a href="<?php echo DOMAIN_WEB; ?>" target="_blank"><?php echo DOMAIN_WEB; ?></a></small>
                        </h2><br>

                        <form action="<?php echo base_url('transaksi/edittransaksidebit_act'); ?>" method="POST">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="tanggal" class="datepicker form-control" placeholder="Tanggal" value="<?php echo date('l d F Y', strtotime($detail->tperiode)); ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">                                        
                            	<select class="form-control show-tick" name="transfer" required>
	                                <?php
	                                  foreach ($lists as $list) { 
	                                ?>
                                    <option value="<?php echo $list->rno; ?>" <?php if($detail->ttujuan==$list->rno) echo 'selected="selected"'?>>
