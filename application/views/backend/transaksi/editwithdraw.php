            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="body">
                        ...
                        <form action="<?php echo base_url('transaksi/editwithdraw_act'); ?>" method="POST">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <select class="form-control show-tick" name="brand" readonly>
                                    <option value="<?php echo $detail->bnama; ?>" selected="selected"><?php echo $detail->bnama; ?></option>
                                </select>
                            </div>
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="deposit" class="form-control" value="<?php echo number_format($deposit); ?>" readonly>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="tujuan" class="form-control" value="<?php echo $detail->cnorek; ?>" readonly>
                            ...
                            <div class="col-sm-12">                                     
                                <select class="form-control show-tick" name="rekening" onchange="getsaldo(this.value)" required>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="nominal" class="form-control" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" value="<?php echo number_format($detail->tgrandtotal); ?>" required>
