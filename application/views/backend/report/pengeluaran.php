                ...
                <div class="card">
                    <div class="body">
                        <h2 class="card-inside-title">
                            REPORT PENGELUARAN
                            <small>Silahkan pilih periode report pengeluaran
                            <a href="<?php echo DOMAIN_WEB; ?>" target="_blank"><?php echo DOMAIN_WEB; ?></a></small>
                        </h2><br>

                        <form action="<?php echo base_url('general/addreportpengeluaran_act'); ?>" method="POST">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="periode" class="datepicker1 form-control" placeholder="Periode" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <button type="submit" name="submit" id="submit" class="btn btn-primary btn-lg waves-effect">CARI</button>
                            </div>
                        </div>
                        </form>
                    </div>
