                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="<?php echo base_url('transaksi/edittransaksikredit/'.$idbrand.'/'.$list->tnomor); ?>" class=" waves-effect waves-block">Edit transaksi</a></li>
                                                    <li><a href="<?php echo base_url('transaksi/hapustransaksikredit/'.$idbrand.'/'.$list->tnomor); ?>" class=" waves-effect waves-block">Hapus</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
