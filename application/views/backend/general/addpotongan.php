                ...
                <div class="card">
                    <div class="body">
                        <h2 class="card-inside-title">
                            Potongan Pembelian Baru
                            <small>Tambah potongan pembelian jumlah kupon 
                            <a href="<?php echo DOMAIN_WEB; ?>" target="_blank"><?php echo DOMAIN_WEB; ?></a></small>
                        </h2><br>

                        <form action="<?php echo base_url('general/addpotongan_act'); ?>" method="POST">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" name="jmhdari" class="form-control" required>
                                        <label class="form-label">Minimal Pemberlian Kupon</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" name="jmhsampai" class="form-control" required>
                                        <label class="form-label">Maksimal Pemberlian Kupon</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
