                ...
                <div class="card">
                    <div class="body">
                        <h2 class="card-inside-title">
                            REPORT PERMAINAN HARIAN
                            <small>Silahkan pilih periode permainan harian
...
function GetCari(){
  ...
  $.ajax({
  type: "POST",
  url: "<?php echo base_url('general/reportpermainanharian_act'); ?>",
  data: {dari:dari,sampai:sampai,email:email,brand:brand}
